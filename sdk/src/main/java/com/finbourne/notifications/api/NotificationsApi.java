...
import com.finbourne.notifications.model.CreateAwsSqsNotification;
...
import com.finbourne.notifications.model.UpdateAwsSqsNotification;
...
public class NotificationsApi {
    ...
    /**
     * Build call for createAwsSqsNotification
     * @param scope The scope that identifies a notification (required)
     * @param code The code that identifies a notification (required)
     * @param createAwsSqsNotification The data to create an message sent to AWS Simple Queue Service (required)
     ...
     */
    public okhttp3.Call createAwsSqsNotificationCall(String scope, String code, CreateAwsSqsNotification createAwsSqsNotification, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = createAwsSqsNotification;

        // create path and map variables
        String localVarPath = "/api/subscriptions/{scope}/{code}/notifications/awssqs"
        ...
        localVarHeaderParams.put("X-LUSID-SDK-Version", "0.1.731");
    ...
    private okhttp3.Call createAwsSqsNotificationValidateBeforeCall(String scope, String code, CreateAwsSqsNotification createAwsSqsNotification, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling createAwsSqsNotification(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling createAwsSqsNotification(Async)");
        }
        
        // verify the required parameter 'createAwsSqsNotification' is set
        if (createAwsSqsNotification == null) {
            throw new ApiException("Missing the required parameter 'createAwsSqsNotification' when calling createAwsSqsNotification(Async)");
        }
        

        okhttp3.Call localVarCall = createAwsSqsNotificationCall(scope, code, createAwsSqsNotification, _callback);
        return localVarCall;
     ...
     */
    public Notification createAwsSqsNotification(String scope, String code, CreateAwsSqsNotification createAwsSqsNotification) throws ApiException {
        ApiResponse<Notification> localVarResp = createAwsSqsNotificationWithHttpInfo(scope, code, createAwsSqsNotification);
     ...
     */
    public ApiResponse<Notification> createAwsSqsNotificationWithHttpInfo(String scope, String code, CreateAwsSqsNotification createAwsSqsNotification) throws ApiException {
        okhttp3.Call localVarCall = createAwsSqsNotificationValidateBeforeCall(scope, code, createAwsSqsNotification, null);
        Type localVarReturnType = new TypeToken<Notification>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] CreateAwsSqsNotification: Add an AWS SQS notification to a subscription. (asynchronously)
     * 
     * @param scope The scope that identifies a notification (required)
     * @param code The code that identifies a notification (required)
     * @param createAwsSqsNotification The data to create an message sent to AWS Simple Queue Service (required)
     ...
     */
    public okhttp3.Call createAwsSqsNotificationAsync(String scope, String code, CreateAwsSqsNotification createAwsSqsNotification, final ApiCallback<Notification> _callback) throws ApiException {
        okhttp3.Call localVarCall = createAwsSqsNotificationValidateBeforeCall(scope, code, createAwsSqsNotification, _callback);
        Type localVarReturnType = new TypeToken<Notification>(){}.getType();
    ...
    /**
     * Build call for updateAwsSqsNotification
     * @param scope The scope that identifies a notification (required)
     * @param code The code that identifies a notification (required)
     * @param id The unique identifier of the notification (required)
     * @param updateAwsSqsNotification The data to update a notification (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateAwsSqsNotificationCall(String scope, String code, String id, UpdateAwsSqsNotification updateAwsSqsNotification, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = updateAwsSqsNotification;

        // create path and map variables
        String localVarPath = "/api/subscriptions/{scope}/{code}/notifications/awssqs/{id}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()))
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateAwsSqsNotificationValidateBeforeCall(String scope, String code, String id, UpdateAwsSqsNotification updateAwsSqsNotification, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling updateAwsSqsNotification(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling updateAwsSqsNotification(Async)");
        }
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateAwsSqsNotification(Async)");
        }
        
        // verify the required parameter 'updateAwsSqsNotification' is set
        if (updateAwsSqsNotification == null) {
            throw new ApiException("Missing the required parameter 'updateAwsSqsNotification' when calling updateAwsSqsNotification(Async)");
        }
        

        okhttp3.Call localVarCall = updateAwsSqsNotificationCall(scope, code, id, updateAwsSqsNotification, _callback);
        return localVarCall;
     ...
     */
    public Notification updateAwsSqsNotification(String scope, String code, String id, UpdateAwsSqsNotification updateAwsSqsNotification) throws ApiException {
        ApiResponse<Notification> localVarResp = updateAwsSqsNotificationWithHttpInfo(scope, code, id, updateAwsSqsNotification);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Notification> updateAwsSqsNotificationWithHttpInfo(String scope, String code, String id, UpdateAwsSqsNotification updateAwsSqsNotification) throws ApiException {
        okhttp3.Call localVarCall = updateAwsSqsNotificationValidateBeforeCall(scope, code, id, updateAwsSqsNotification, null);
        Type localVarReturnType = new TypeToken<Notification>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] UpdateAwsSqsNotification: Update an AWS SQS notification for a given subscription. (asynchronously)
     * 
     * @param scope The scope that identifies a notification (required)
     * @param code The code that identifies a notification (required)
     * @param id The unique identifier of the notification (required)
     ...
     */
    public okhttp3.Call updateAwsSqsNotificationAsync(String scope, String code, String id, UpdateAwsSqsNotification updateAwsSqsNotification, final ApiCallback<Notification> _callback) throws ApiException {
        okhttp3.Call localVarCall = updateAwsSqsNotificationValidateBeforeCall(scope, code, id, updateAwsSqsNotification, _callback);
        Type localVarReturnType = new TypeToken<Notification>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
