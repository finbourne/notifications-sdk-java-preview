...
public class CreateAwsSqsNotification {
  ...
  public CreateAwsSqsNotification apiKeyRef(String apiKeyRef) {
  ...
  **/
  ...
  public CreateAwsSqsNotification apiSecretRef(String apiSecretRef) {
  ...
  **/
  ...
  public CreateAwsSqsNotification body(String body) {
    this.body = body; 
    return this;
  }
  ...
  **/
  ...
  public CreateAwsSqsNotification description(String description) {
  ...
  **/
  ...
  public CreateAwsSqsNotification queueUrlRef(String queueUrlRef) {
