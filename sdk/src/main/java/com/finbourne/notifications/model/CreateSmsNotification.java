 ...
 */
@ApiModel(description = "The information required to create a notification which, when processed, will send an SMS")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class CreateSmsNotification {
  ...
  public CreateSmsNotification description(String description) {
  ...
  **/
  ...
  public CreateSmsNotification body(String body) {
    this.body = body; 
    return this;
  }
  ...
  **/
  ...
  public CreateSmsNotification recipients(List<String> recipients) {
    this.recipients = recipients; 
    return this;
  }

  public CreateSmsNotification addRecipientsItem(String recipientsItem) {
